...
version_of_fontawesome_json = "7.2.0"
menu_title = 'Font Awesome 7 Free v' + version_of_fontawesome_json

# full font names
font_name_hash = {
    'regular': "Font Awesome 7 Free Regular",
    'solid':   "Font Awesome 7 Free Solid",
    'brands':  "Font Awesome 7 Brands Regular"
}
...
file = os.path.join(os.path.dirname(os.path.realpath(__file__)), "fa6-icons.json")
...
def get_content_categories():
    ...
    categories = []
    file = os.path.join(os.path.dirname(os.path.realpath(__file__)), "fa6-categories.json")
    with io.open(file, 'r', encoding='utf-8') as json_file:

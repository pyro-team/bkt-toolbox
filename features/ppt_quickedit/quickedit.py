...
class QuickEditPanelManager(object):
    ...
    @classmethod
    def update_panel_position2(cls, slide_range, context):
        logging.debug("update panel position for active window")
...
bkt.AppEvents.slide_selection_changed    += bkt.Callback(QuickEditPanelManager.update_panel_position2, context=True)

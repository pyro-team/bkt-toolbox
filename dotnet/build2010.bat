...
:: RUN MSBUILD
@echo on
%framework_path%\msbuild bkt.sln /t:Rebuild /p:Configuration=Office2010 "/p:Platform=Any cpu"


:: COPY FILES
copy bkt-addin\bin\Debug-O2010\*.* ..\bin
copy bkt-dev-addin\bin\Debug-O2010\BKT.Dev.* ..\bin

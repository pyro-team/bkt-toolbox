...
Filename: "{app}\bin\ipy.exe"; Parameters: "-m bkt_install install -s --apps powerpoint excel visio"; WorkingDir: "{app}\installer"; StatusMsg: "Office-AddIn für PowerPoint, Excel und Visio einrichten..."; Flags: runasoriginaluser runhidden; Components: excel and visio
